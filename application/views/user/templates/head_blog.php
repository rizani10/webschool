...
<head>
  ...
  <link href="<?= base_url('assets/back-and/') ?>css/jquery.dataTables.min.css" rel="stylesheet">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/front-end/') ?>styles/blog_single.css">
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/front-end/') ?>styles/blog_single_responsive.css">
